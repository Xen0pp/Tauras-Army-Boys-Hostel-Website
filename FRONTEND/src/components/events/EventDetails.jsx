  ...
  return (
    <div className=" container mx-auto  rounded-xl overflow-y-auto bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white pb-20">
      ...
      <div className="relative lg:h-[40vh] h-[30vh] w-full overflow-hidden">
        ...
        {/* Background Image */}
        <Image
          src={data?.event?.image || data?.event?.imageUrl || "/placeholder.svg?height=800&width=1200"}
          alt={data?.event?.event_name || data?.event?.eventName}
          fill
      ...
      <div className="container mx-auto px-4 -mt-10 relative z-30">
        ...
        >
          <div className="lg:col-span-2">
            ...
            <Countdown itemVariants={itemVariants} date={data?.event?.date} />
          </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-medium">{data?.event?.event_type || data?.event?.eventType || "General"}</p>
                  </div>
                </motion.div>
              </div>
