...
const AlumniProfile = () => {
  ...
  const { data: response, isLoading } = useGetAnyUserDetails(params.id);
      ...
      <AnimatePresence>
        {isLoading ? (
          ...
          >
            {/* Main Profile Card */}
            <Card
              className={`overflow-hidden ${isDark
            ...
            >
              ...
              <div
                className={`h-32 relative ${isDark
              ...
              <div className="px-6 pb-6 relative">
                ...
                <div className="relative -mt-16 mb-4 flex justify-between items-end">
                  ...
                  >
                    <div
                      className={`absolute inset-0 rounded-full blur-sm opacity-70 animate-pulse ${isDark
                    ...
                    />
                    <Avatar
                      className={`h-32 w-32 relative ${isDark
                    ...
                    >
                      ...
                      />
                      <AvatarFallback
                        className={`text-white text-2xl ${isDark
                  ...
                  <Badge
                    className={`border-0 py-1.5 ${isDark
                  ...
                  >
                    ...
                    >
                      <CardContent className="p-4 space-y-4">
                        <h3
                          className={`text-lg font-semibold flex items-center gap-2 ${isDark ? "text-white/90" : "text-gray-800"
                            }`}
                        >
                          <span
                    ...
                    {userInfo?.experience && (
                      ...
                      >
                        <CardContent className="p-4">
                          <h3
                            className={`text-lg font-semibold flex items-center gap-2 mb-3 ${isDark ? "text-white/90" : "text-gray-800"
                              }`}
                          >
                            <span
                              className={`h-5 w-1 rounded-full ${isDark
    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-6 relative">
          <div className="relative -mt-16 mb-4 flex justify-between items-end">
            <Skeleton
              className={`h-32 w-32 rounded-full ${isDark ? "bg-gray-800" : "bg-gray-200"
                }`}
            />
            <Skeleton
          ...
          <Skeleton
            className={`h-10 w-64 mb-2 ${isDark ? "bg-gray-800" : "bg-gray-200"
              }`}
          />
          <Skeleton
            className={`h-5 w-40 mb-6 ${isDark ? "bg-gray-800" : "bg-gray-200"
              }`}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 space-y-6">
              <div className="space-y-2">
                <Skeleton
                  className={`h-7 w-32 ${isDark ? "bg-gray-800" : "bg-gray-200"
                    }`}
                />
                <Skeleton
                  className={`h-4 w-full ${isDark ? "bg-gray-800" : "bg-gray-200"
                    }`}
                />
                <Skeleton
                  className={`h-4 w-full ${isDark ? "bg-gray-800" : "bg-gray-200"
                ...
                />
                <Skeleton
                  className={`h-4 w-3/4 ${isDark ? "bg-gray-800" : "bg-gray-200"
                    }`}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {[1, 2, 3, 4].map((i) => (
                    <Skeleton
                      key={i}
                      className={`h-6 w-20 ${isDark ? "bg-gray-800" : "bg-gray-200"
                        }`}
                    />
                  ))}
                </div>
            ...
            <div className="space-y-6">
              ...
              >
                <CardContent className="p-4 space-y-4">
                  <Skeleton
                    className={`h-7 w-48 ${isDark ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                  <div className="space-y-3">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-start gap-2">
                        <Skeleton
                          className={`h-5 w-5 ${isDark ? "bg-gray-800" : "bg-gray-200"
                            }`}
                        />
                        <div className="space-y-1 flex-1">
                          <Skeleton
                            className={`h-4 w-20 ${isDark ? "bg-gray-800" : "bg-gray-200"
                              }`}
                          />
                          <Skeleton
                            className={`h-4 w-full ${isDark ? "bg-gray-800" : "bg-gray-200"
              ...
              >
                <CardContent className="p-4">
                  <Skeleton
                    className={`h-7 w-32 mb-3 ${isDark ? "bg-gray-800" : "bg-gray-200"
                      }`}
                  />
                  <div className="flex gap-3">
                    {[1, 2, 3, 4].map((i) => (
                      <Skeleton
                        key={i}
                        className={`h-10 w-10 rounded-full ${isDark ? "bg-gray-800" : "bg-gray-200"
                          }`}
                      />
                    ))}
                  </div>
